...
//START RHO-BOT
//Starbreaker cvars
//begin Bot blood color
cvar_t  bot_blood = {"bot_blood", "0"};
...
//END RHO-BOT
	...
	char szMapChangeCommand[50];
	sprintf( szMapChangeCommand, "map \"%s\"\n", BotGlobals.InitialMap );

	SERVER_COMMAND( szMapChangeCommand );
